...
import skeleton from '../styles/home-skeleton.module.css';
...
const Home = () => {
  ...
  const getSampleWorks = async () => {
    const result = await fetchSampleWorks((window.innerWidth > 922) ? 5 : 15);
  ...
  useEffect(() => {
    const handleResize = () => {
      setShowExpandedWork(window.innerWidth > 922);
    };
        ...
        <motion.div ref={carousel} className={styles.carousel}>
          {loading ? (
            ...
            <motion.div
              ...
              className={styles.innerCarousel}
              animate={window.innerWidth > 922 ? '' : controls}
            >
